...
\setmainjfont[Path=\JPFontDir,%
	SmallCapsFont=NotoSerifJP-Medium,%
	BoldItalicFont=NotoSerifJP-SemiBold,%
	ItalicFont=NotoSerifJP-ExtraLight,%
	BoldFont=NotoSerifJP-Bold%
]{NotoSerifJP-Regular}%
\setsansjfont[Path=\JPFontDir,%
	SmallCapsFont=NotoSansJP-Light,%
	BoldItalicFont=NotoSansJP-Bold,%
	ItalicFont=NotoSansJP-Light,%
	BoldFont=NotoSansJP-Bold%
]{NotoSansJP-Regular}%
