...
% \setmainjfont{Meiryo UI}[Path=./0organization/1main/4aids/fonts/fonts/]% \mcfamily
% \setsansjfont{Malgun}[Path=./0organization/1main/4aids/fonts/fonts/]% \gtfamily
\setmainjfont[Path=\DenKrLayoutMainRootDir/4aids/fonts/]{HanaMinA}% \mcfamily  % Font available for free download and installation on system "Hanazono Mincho". (Copy here in "./0organization/1main/4aids/fonts/")
