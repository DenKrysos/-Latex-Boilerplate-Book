...
\renewcommand*\chapterlinesformat[3]{%
    \Ifstr{#1}{chapter}{%
        ...
        \ifstrempty{#2}{}{%
            \sbox{\tmpbox}{%
                \usekomafont{chapternumber}\parbox{2em}{\usekomafont{chapternumber}\chapSplit{1}{\thechapter}}%
            }%
        }%
        \begin{tikzpicture}[baseline=(title.base)]%
            % Background
            \node[outer sep=0pt,inner sep=5pt,shade,left color=white,right color=DenKrKomaColor_ChapterHeading_2](title){%
                \parbox[t]%
